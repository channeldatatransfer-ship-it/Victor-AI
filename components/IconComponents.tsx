...
export const SpeakerOnIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      <path d="M13.5 4.06c0-1.336-1.616-2.005-2.56-1.06l-4.5 4.5H4.508c-1.141 0-2.318.664-2.66 1.905A9.76 9.76 0 001.5 12c0 .898.121 1.768.348 2.595.341 1.24 1.518 1.905 2.66 1.905H6.44l4.5 4.5c.944.945 2.56.276 2.56-1.06V4.06zM18.584 12c0-1.857-.87-3.534-2.274-4.636a.75.75 0 10-.916 1.172A4.5 4.5 0 0117.084 12a4.5 4.5 0 01-1.69 3.464a.75.75 0 00.916 1.172c1.403-1.102 2.274-2.779 2.274-4.636z" />
      <path d="M21.584 12c0-3.35-.973-6.411-2.732-8.913a.75.75 0 00-1.134.974 9 9 0 012.366 7.939 9 9 0 01-2.366 7.939a.75.75 0 001.134.974c1.759-2.502 2.732-5.563 2.732-8.913z" />
    </svg>
);
